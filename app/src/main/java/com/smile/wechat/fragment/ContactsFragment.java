...
import com.smile.wechat.activity.AllTagActvitiy;
import com.smile.wechat.activity.MainActivity;
import com.smile.wechat.activity.NewFriendActivity;
import com.smile.wechat.activity.TeamCheatListActivity;
            ...
            public void onLetterUpdate(String letter) {
                ...
                if ("↑".equalsIgnoreCase(letter)) {
                    ...
                    for (i = 0; i < mContacts.size(); i++) {
                        ...
                        String c = contact.getName().charAt(0) + "";
...
//        ((MainActivity) getActivity()).updateContactCount();
    ...
    private void initHeaderViewAndFooterView() {
        ...
        mLlOffical.setVisibility(View.GONE);
    ...
    private void setAdapter() {
        mAdapter = new LQRAdapterForRecyclerView<Contact>(getActivity(), R.layout.item_contact_cv, mContacts) {
            ...
            public void convert(LQRViewHolderForRecyclerView helper, final Contact item, int position) {
                ...
                String str = "";
                //得到当前字母
                String currentLetter = item.getName().charAt(0) + "";

                if (position == 0) {
                    str = currentLetter;
                } else {
                    //得到上一个字母
                    String preLetter = mContacts.get(position - 1).getName().charAt(0) + "";
                    ...
                    if (nextIndex < mContacts.size() - 1) {
                        //得到下一个字母
                        String nextLetter = mContacts.get(nextIndex).getName().charAt(0) + "";
