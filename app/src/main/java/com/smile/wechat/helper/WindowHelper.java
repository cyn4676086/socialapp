...
public class WindowHelper {
    ...
    private static volatile com.smile.wechat.helper.WindowHelper mInstance = null;
    ...
    public static com.smile.wechat.helper.WindowHelper getInstance() {
        if (mInstance == null) {
            synchronized (com.smile.wechat.helper.WindowHelper.class) {
                if (mInstance == null) {
                    mInstance = new com.smile.wechat.helper.WindowHelper();
                }
            }
        }
        return mInstance;
     ...
     * @return
     */
    public View getViewWindow(int layoutId) {
